...
export default function ContentCard() {
  return (
      <div className="w-full h-96 mt-3 mb-3 flex flex-col flex-basis-1/2 md:flex-row rounded shadow overflow-hidden">
        <div className="h-1/2 w-full lg:w-1/2 lg:h-full bg-orange-400 relative">
            <Image src="/meetup.jpg" alt="caption photo" fill objectFit='cover'></Image>

        </div>
        <div className='bg-blue-100 text-white dark:text-white w-full lg:w-1/2 p-10 flex items-center justify-center'>
